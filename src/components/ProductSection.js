              ...
              <div>
                ...
                <div className="mt-4">
                  <a
                    ...
                    target="_blank"
                    className="inline-block cursor-pointer bg-green-500 px-4 py-3 opacity-75 shadow-lg shadow-green-500/50 text-white font-semibold rounded-full group hover:bg-green-300 hover:text-green-900"
                  >
